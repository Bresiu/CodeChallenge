package com.bresiu.codechallenge.presentation.views
...
class HeaderItemDecoration(recyclerView: RecyclerView, private val mListener: StickyHeaderInterface) : RecyclerView.ItemDecoration() {
  ...
  init {
    recyclerView.addOnItemTouchListener(object : RecyclerView.OnItemTouchListener {
      override fun onInterceptTouchEvent(recyclerView: RecyclerView,
        ...
        return motionEvent.y <= stickyHeaderHeight
      }
  ...
  private fun getHeaderViewForItem(itemPosition: Int, parent: RecyclerView): View {
    ...
    val header = LayoutInflater.from(parent.context).inflate(layoutResId, parent, false) as TextView
  ...
  interface StickyHeaderInterface {
    ...
    /**
     * This method gets called by [HeaderItemDecoration] to verify whether the item represents
     * a header.
     *
