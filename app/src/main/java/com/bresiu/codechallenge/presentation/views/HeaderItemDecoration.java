...
public class HeaderItemDecoration extends RecyclerView.ItemDecoration {
	...
	@Override public void onDrawOver(@NotNull Canvas c, @NotNull RecyclerView parent,
	...
	private View getHeaderViewForItem(int itemPosition, RecyclerView parent) {
		...
		TextView header =
				(TextView) LayoutInflater.from(parent.getContext()).inflate(layoutResId, parent, false);
